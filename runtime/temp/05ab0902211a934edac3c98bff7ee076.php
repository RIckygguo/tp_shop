<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\xampp\htdocs\tp_shop\public/../application/admin\view\category\index.html";i:1522766102;s:75:"D:\xampp\htdocs\tp_shop\public/../application/admin\view\Public\header.html";i:1521882563;s:75:"D:\xampp\htdocs\tp_shop\public/../application/admin\view\public\footer.html";i:1521010733;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="javascript:;" onclick="addRecord('添加分类','<?php echo url('Category/add'); ?>','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a></span> <span class="r">共有数据：<strong><?php echo $count; ?></strong> 条</span> </div>
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-status">
					...
					<td class="td-manage">
							<a style="text-decoration: none" onclick="" href="<?php echo url('Category/index', ['parent_id' => $vo['id']]); ?>" title="获取子栏目">获取子分类</a>
<!-- 						<?php if(strpos($vo['status'], '正常') != FALSE): ?>
						...
						<?php endif; ?>
								...
								<a title="编辑" href="javascript:;" onclick="editRecord('分类编辑', '<?php echo url('Category/edit',['id' => $vo['id']]); ?>','2','800','500')" class="ml-5" style="text-decoration:none">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20 tp-shop"><?php echo $cate->render();; ?></div>
</div>
<!--_footer 作为公共模版分离出去-->
...
var SCOPE = {
	delete_url : "<?php echo url('Category/delete'); ?>",
	change_status_url : "<?php echo url('Category/changeStatus'); ?>",
	list_url : "<?php echo url('Category/changeList'); ?>",
}
/*
	参数解释：
	title	标题
