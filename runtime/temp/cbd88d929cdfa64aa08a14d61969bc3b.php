<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\xampp\htdocs\tp_shop\public/../application/admin\view\category\add.html";i:1522766100;s:75:"D:\xampp\htdocs\tp_shop\public/../application/admin\view\Public\header.html";i:1521882563;s:75:"D:\xampp\htdocs\tp_shop\public/../application/admin\view\public\footer.html";i:1521010733;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9" style="width: 350px;">
            <input type="text" class="input-text" value="" placeholder="" id="cateName" name="name">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3">分类栏目：</label>
        <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:300px;">
            <select class="select" name="parent_id" size="1">
                ...
                <?php if(is_array($firstCate) || $firstCate instanceof \think\Collection): $i = 0; $__LIST__ = $firstCate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
...
var SCOPE = {
    'add_url' : "<?php echo url('Category/save'); ?>",
};
$(function(){
